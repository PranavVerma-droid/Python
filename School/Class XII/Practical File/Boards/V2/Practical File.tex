...
\lstnewenvironment{codeexample}
{\lstset{frame=single,numbers=none,basicstyle=\small\ttfamily}}{}

\title{LOTUS VALLEY INTERNATIONAL SCHOOL \\ 
    \large Computer Science Practical File}
\author{Pranav Verma \\ Roll No: \\ XII Aryabhatta}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Pranav Verma}
\fancyhead[R]{CS Practical File: Page \thepage}
...
\includegraphics[width=1\textwidth]{images/6/6_11.png}
